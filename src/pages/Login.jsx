...
export function AuthShell({ children }) {
  return (
    <div className="relative min-h-dvh overflow-hidden bg-[#eef6f0]">
      <div className="absolute inset-x-0 top-0 h-[42vh] bg-[linear-gradient(180deg,#0d5c28_0%,#1a9440_48%,#5dcc78_100%)]" />
      <div className="absolute -left-[20%] top-[28vh] h-[220px] w-[140%] rounded-[50%] bg-[#eef6f0]" />

      <div className="relative z-10 mx-auto flex min-h-dvh max-w-[430px] flex-col items-center px-5 pt-[max(1.1rem,env(safe-area-inset-top))] pb-10">
        <img
          src="/logo-white.png"
          alt="International Agriculture University"
          className="relative z-20 mb-5 h-[128px] w-[128px] bg-transparent object-contain drop-shadow-[0_8px_18px_rgba(8,40,90,0.25)]"
        />
        <div className="w-full rounded-[28px] bg-white px-5 py-7 shadow-[0_18px_50px_rgba(16,90,40,0.14)]">{children}</div>
      </div>
    </div>
  )
}

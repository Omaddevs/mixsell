...
import { Cover, PrimaryBtn } from '../components/ui'
import { downloadBook } from './Library'
...
export default function BookDetail() {
  ...
  return (
    <RoleScreen title="Kitob" back="/library" right={<Bookmark className="text-slate-400" />}>
      <SoftCard className="overflow-hidden p-0">
        <div className="h-56">
          {book.coverData ? <img src={book.coverData} alt="" className="h-56 w-full object-cover" /> : <Cover type={book.cover} title={book.title} />}
        </div>
